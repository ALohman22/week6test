...
const drawFive = () => {
    axios.get('http:http://13.59.100.4//api/robots/five')
        .then(res => {
...
const duel = () => {
    ...
    setTimeout(() => {
        axios.post('http://http://13.59.100.4//api/duel', {compDuo, playerDuo})
            .then(({data}) => {
...
const getPlayerStats = () => {
    axios.get('http://http://13.59.100.4//api/player')
...
const getAllBots = () => {
    axios.get('http://http://13.59.100.4//api/robots')
        .then(({data}) => {
